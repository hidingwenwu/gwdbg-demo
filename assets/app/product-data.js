(function (root, factory) {
  ...
  return {
    ...
    scenes: [
      { tag: '商场 · 办公', title: '多联机集控改造方案', desc: '4/8 路多通道控制器接入室外机总线，统一监控与批量控制', products: 'A01F / A01E', series: 'a01' },
      { tag: '园区 · 医院', title: '大体量多联机集中管控方案', desc: '第二代控制器分通道品牌配置，多品牌混装分区管理', products: 'A02FG / A02EG', series: 'a02' },
      { tag: '分散站点', title: '无网络机房 4G 直连方案', desc: '内置 4G 控制器免拉网线，分散站点直连云端上线', products: 'A03FG', series: 'a03fg' },
      { tag: '酒店 · 办公', title: '风机盘管集中控制改造方案', desc: '风机盘管温控器替代传统线控器，统一温控与日程策略', products: 'F16G', series: 'f16g' },
